...
class StockMovementEntityServiceTest {
    ...
    void deveRecordMovementEntrada() {
        ...
        StockMovementEntity movimentoEntity = new StockMovementEntity();
        StockMovementEntity savedEntity = new StockMovementEntity();
